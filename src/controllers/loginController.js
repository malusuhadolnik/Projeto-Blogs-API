...
const inspectBodyInfo = (email, password) => email && password
//exemplo da aula do zambs, lecture/backend 6.4
...
module.exports = async (req, res) => {
  try {
    ...
    const isDataValid = await loginService.validateUserLogin( email, password );
